...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.events'
        db.add_column(u'django_mailbox_message', 'events',
                      self.gf('django_hstore.fields.DictionaryField')(default='""=>""'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.events'
        db.delete_column(u'django_mailbox_message', 'events')
    ...
    models = {
        ...
        u'django_mailbox.message': {
            ...
            'events': ('django_hstore.fields.DictionaryField', [], {'default': "{'': ''}"}),
            ...
            'lead': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'messages'", 'null': 'True', 'to': u"orm['leads.Lead']"}),
            ...
            'to_header': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        ...
        u'leads.lead': {
            ...
            'events': ('django_hstore.fields.DictionaryField', [], {'default': "{u'': u''}"}),
        ...
        u'leads.property': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'property_ids': ('django_hstore.fields.DictionaryField', [], {'default': "{u'': u''}", 'db_index': 'True'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
