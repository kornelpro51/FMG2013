...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'leads_note', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom_user.EmailUser']))

    def backwards(self, orm):

        # Changing field 'Note.user'
        db.alter_column(u'leads_note', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
