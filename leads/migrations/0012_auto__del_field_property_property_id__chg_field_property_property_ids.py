...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Property.property_id'
        db.delete_column(u'leads_property', 'property_id')


        # Changing field 'Property.property_ids'
        db.alter_column(u'leads_property', 'property_ids', self.gf('djorm_hstore.fields.DictionaryField')(default='"key"=>"value"'))

    def backwards(self, orm):
        # Adding field 'Property.property_id'
        db.add_column(u'leads_property', 'property_id',
                      self.gf('django.db.models.fields.CharField')(default='not set', max_length=255),
                      keep_default=False)


        # Changing field 'Property.property_ids'
        db.alter_column(u'leads_property', 'property_ids', self.gf('djorm_hstore.fields.DictionaryField')(null=True))
    ...
    models = {
        ...
        u'leads.customer': {
            'Meta': {'unique_together': "((u'email', u'agency'),)", 'object_name': 'Customer'},
