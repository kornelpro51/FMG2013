...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.property_ids'
        db.add_column(u'leads_property', 'property_ids',
                      self.gf('djorm_hstore.fields.DictionaryField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.property_ids'
        db.delete_column(u'leads_property', 'property_ids')
    ...
    models = {
        ...
        u'leads.property': {
            ...
            'property_ids': ('djorm_hstore.fields.DictionaryField', [], {'null': 'True', 'db_index': 'True'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
