...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['email', 'agency']
        db.delete_unique(u'leads_customer', ['email', 'agency_id'])


        # Changing field 'Customer.email'
        db.alter_column(u'leads_customer', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Customer.email'
        db.alter_column(u'leads_customer', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))
        # Adding unique constraint on 'Customer', fields ['email', 'agency']
        db.create_unique(u'leads_customer', ['email', 'agency_id'])
    ...
    models = {
        ...
        u'leads.leadproperty': {
            'Meta': {'ordering': "[u'-id']", 'object_name': 'LeadProperty'},
            'agency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['agencies.Agency']", 'null': 'True'}),
        ...
        u'leads.property': {
            ...
            'lofts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'property_ids': ('djorm_hstore.fields.DictionaryField', [], {'db_index': 'True'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
