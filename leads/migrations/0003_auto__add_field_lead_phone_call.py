...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lead.phone_call'
        db.add_column(u'leads_lead', 'phone_call',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lead.phone_call'
        db.delete_column(u'leads_lead', 'phone_call')
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'properties': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'proposing_leads'", 'null': 'True', 'through': u"orm['leads.LeadProperty']", 'to': u"orm['leads.Property']"}),
