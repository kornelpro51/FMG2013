...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'leads_property', 'property_ids', self.gf('django_hstore.fields.DictionaryField')())
        # Adding field 'Lead.events'
        db.add_column(u'leads_lead', 'events',
                      self.gf('django_hstore.fields.DictionaryField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Property.property_ids'
        db.alter_column(u'leads_property', 'property_ids', self.gf('djorm_hstore.fields.DictionaryField')())
        # Deleting field 'Lead.events'
        db.delete_column(u'leads_lead', 'events')
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'events': ('django_hstore.fields.DictionaryField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'leads.property': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'property_ids': ('django_hstore.fields.DictionaryField', [], {'db_index': 'True'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '8', 'decimal_places': '2'}),
