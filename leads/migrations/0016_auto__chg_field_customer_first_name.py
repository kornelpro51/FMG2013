...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'leads_customer', 'first_name', self.gf('django.db.models.fields.CharField')(default='Anonim', max_length=255))

    def backwards(self, orm):

        # Changing field 'Customer.first_name'
        db.alter_column(u'leads_customer', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
