...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'leads_property', 'bathrooms', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Property.bathrooms'
        db.alter_column(u'leads_property', 'bathrooms', self.gf('django.db.models.fields.IntegerField')())
