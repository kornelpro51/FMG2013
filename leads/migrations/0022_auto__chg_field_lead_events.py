...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lead.events'
        db.alter_column(u'leads_lead', 'events', self.gf('django_hstore.fields.DictionaryField')(default={"": ""}))

    def backwards(self, orm):

        # Changing field 'Lead.events'
        db.alter_column(u'leads_lead', 'events', self.gf('django_hstore.fields.DictionaryField')(null=True))
    ...
    models = {
        ...
        u'leads.lead': {
            ...
            'events': ('django_hstore.fields.DictionaryField', [], {'default': 'u\'"key"=>"value"\''}),
