...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'leads_property', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency'], null=True),
                      keep_default=False)

        # Adding field 'LeadProperty.agency'
        db.add_column(u'leads_leadproperty', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency'], null=True),
                      keep_default=False)

        # Adding field 'Note.agency'
        db.add_column(u'leads_note', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency'], null=True),
                      keep_default=False)

        # Adding field 'Lead.agency'
        db.add_column(u'leads_lead', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'leads_property', 'agency_id')

        # Deleting field 'LeadProperty.agency'
        db.delete_column(u'leads_leadproperty', 'agency_id')

        # Deleting field 'Note.agency'
        db.delete_column(u'leads_note', 'agency_id')

        # Deleting field 'Lead.agency'
        db.delete_column(u'leads_lead', 'agency_id')
