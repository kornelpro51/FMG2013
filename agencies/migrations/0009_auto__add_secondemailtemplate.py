...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SecondEmailTemplate'
        db.create_table(u'agencies_secondemailtemplate', (
        ...
        db.send_create_signal(u'agencies', ['SecondEmailTemplate'])


    def backwards(self, orm):
        # Deleting model 'SecondEmailTemplate'
        db.delete_table(u'agencies_secondemailtemplate')
