...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Agent.mugshot'
        db.delete_column(u'agencies_agent', 'mugshot')

        # Deleting field 'Agent.privacy'
        db.delete_column(u'agencies_agent', 'privacy')


        # Changing field 'Agent.user'
        db.alter_column(u'agencies_agent', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['custom_user.EmailUser']))

    def backwards(self, orm):
        # Adding field 'Agent.mugshot'
        db.add_column(u'agencies_agent', 'mugshot',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Agent.privacy'
        db.add_column(u'agencies_agent', 'privacy',
                      self.gf('django.db.models.fields.CharField')(default='registered', max_length=15),
                      keep_default=False)


        # Changing field 'Agent.user'
        db.alter_column(u'agencies_agent', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'agencies.specialoffertemplate': {
            ...
            'end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'}),
            'html_template': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'})
        },
        u'auth.group': {
