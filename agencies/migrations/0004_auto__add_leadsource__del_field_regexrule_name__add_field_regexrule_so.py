...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeadSource'
        db.create_table(u'agencies_leadsource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('agency', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sources', to=orm['agencies.Agency'])),
        ))
        db.send_create_signal(u'agencies', ['LeadSource'])
        ...
        # Deleting field 'RegexRule.name'
        db.delete_column(u'agencies_regexrule', 'name')

        # Adding field 'RegexRule.source'
        db.add_column(u'agencies_regexrule', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'rules', null=True, to=orm['agencies.LeadSource']),
                      keep_default=False)

        # Adding field 'RegexRule.target_field'
        db.add_column(u'agencies_regexrule', 'target_field',
                      self.gf('django.db.models.fields.CharField')(default=u'source_id', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LeadSource'
        db.delete_table(u'agencies_leadsource')
        ...
        # Adding field 'RegexRule.name'
        db.add_column(u'agencies_regexrule', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'RegexRule.source'
        db.delete_column(u'agencies_regexrule', 'source_id')

        # Deleting field 'RegexRule.target_field'
        db.delete_column(u'agencies_regexrule', 'target_field')
