...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConciergeTemplate'
        db.create_table(u'agencies_conciergetemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agency', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agencies.Agency'], unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('html_template', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'agencies', ['ConciergeTemplate'])

        # Adding model 'SpecialOfferTemplate'
        db.create_table(u'agencies_specialoffertemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('start', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('end', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('html_template', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'agencies', ['SpecialOfferTemplate'])

        # Deleting field 'EmailTemplate.text_template'
        db.delete_column(u'agencies_emailtemplate', 'text_template')


        # Changing field 'EmailTemplate.agency'
        db.alter_column(u'agencies_emailtemplate', 'agency_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agencies.Agency'], unique=True))
        # Adding unique constraint on 'EmailTemplate', fields ['agency']
        db.create_unique(u'agencies_emailtemplate', ['agency_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailTemplate', fields ['agency']
        db.delete_unique(u'agencies_emailtemplate', ['agency_id'])

        # Deleting model 'ConciergeTemplate'
        db.delete_table(u'agencies_conciergetemplate')

        # Deleting model 'SpecialOfferTemplate'
        db.delete_table(u'agencies_specialoffertemplate')

        # Adding field 'EmailTemplate.text_template'
        db.add_column(u'agencies_emailtemplate', 'text_template',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'EmailTemplate.agency'
        db.alter_column(u'agencies_emailtemplate', 'agency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencies.Agency']))
    ...
    models = {
        ...
        u'agencies.specialoffertemplate': {
            ...
            'end': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'html_template': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'start': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'auth.group': {
