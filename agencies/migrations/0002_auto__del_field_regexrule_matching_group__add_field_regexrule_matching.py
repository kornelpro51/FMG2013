...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RegExRule.matching_group'
        db.delete_column(u'agencies_regexrule', 'matching_group')

        # Adding field 'RegexRule.matching_group_name'
        db.add_column(u'agencies_regexrule', 'matching_group_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'RegexRule.field'
        db.add_column(u'agencies_regexrule', 'field',
                      self.gf('django.db.models.fields.CharField')(default='body', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RegExRule.matching_group'
        db.add_column(u'agencies_regexrule', 'matching_group',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'RegexRule.matching_group_name'
        db.delete_column(u'agencies_regexrule', 'matching_group_name')

        # Deleting field 'RegexRule.field'
        db.delete_column(u'agencies_regexrule', 'field')
    ...
    models = {
        ...
        u'agencies.agency': {
            ...
            'arrival': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'leads_arrivals'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['agencies.RegexRule']"}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.City']", 'null': 'True', 'blank': 'True'}),
            'customer_email': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'leads_customer_emails'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['agencies.RegexRule']"}),
            'customer_name': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'leads_customer_names'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['agencies.RegexRule']"}),
            'departure': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'leads_departures'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['agencies.RegexRule']"}),
            ...
            'property_id': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'leads_property_ids'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['agencies.RegexRule']"}),
        ...
        u'agencies.regexrule': {
            ...
            'field': ('django.db.models.fields.CharField', [], {'default': "'body'", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
