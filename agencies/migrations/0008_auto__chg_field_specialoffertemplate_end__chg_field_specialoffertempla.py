...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecialOfferTemplate.end'
        db.alter_column(u'agencies_specialoffertemplate', 'end', self.gf('django.db.models.fields.DateField')())

        # Changing field 'SpecialOfferTemplate.start'
        db.alter_column(u'agencies_specialoffertemplate', 'start', self.gf('django.db.models.fields.DateField')())
        # Adding field 'Agency.fax'
        db.add_column(u'agencies_agency', 'fax',
                      self.gf('django_localflavor_us.models.PhoneNumberField')(max_length=20, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SpecialOfferTemplate.end'
        db.alter_column(u'agencies_specialoffertemplate', 'end', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'SpecialOfferTemplate.start'
        db.alter_column(u'agencies_specialoffertemplate', 'start', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Deleting field 'Agency.fax'
        db.delete_column(u'agencies_agency', 'fax')
    ...
    models = {
        ...
        u'agencies.specialoffertemplate': {
            ...
            'end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'}),
            'html_template': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 1, 0, 0)'})
        },
        u'auth.group': {
