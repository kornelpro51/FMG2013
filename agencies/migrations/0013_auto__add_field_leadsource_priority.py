...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeadSource.priority'
        db.add_column(u'agencies_leadsource', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeadSource.priority'
        db.delete_column(u'agencies_leadsource', 'priority')
    ...
    models = {
        ...
        u'agencies.specialoffertemplate': {
            ...
            'end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
            'html_template': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'start': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'})
        },
        u'auth.group': {
